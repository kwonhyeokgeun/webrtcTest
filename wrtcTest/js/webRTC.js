...
function userOntrackHandler(stream, userName, senderSocketId) {   //##################수정해서 쓰삼#######################
...
//새로운 유저 비디오 생성
function makeUserVideo(socketId, userName){   //##################수정해서 쓰삼#######################
...
//나간 유저 video삭제
function removeUserVideo(socketId, userName){   //##################수정해서 쓰삼#######################
...
//화면 공유용 비디오 생성
function makeShareVideo(){   //##################수정해서 쓰삼#######################
...
//화면공유 비디오 삭제
function removeShareVideo(){   //##################수정해서 쓰삼#######################
    let shareVideo = document.querySelector("#share_video");
    shareVideo.remove();
}

//화면 공유 stream을 video에 넣음
function shareOntrackHandler(stream, userName, senderSocketId) {   //##################수정해서 쓰삼#######################
